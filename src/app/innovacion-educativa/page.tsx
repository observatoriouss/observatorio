...
function InnovationEducativePage() {
    return (
        <div className='w-full flex flex-col items-center'>
            <div className='pt-6 pb-12 w-full max-w-2xl flex flex-col gap-4 text-justify font-light'>
                <h1 className='text-uss-black text-2xl md:text-3xl lg:text-4xl text-left font-medium'>¿Qué es innovación educativa?</h1>
                ...
                <h2 className='font-medium text-xl'>Tipos de innovación educativa</h2>
...
export default InnovationEducativePage