            ...
            {post && (
                <div className='container max-w-5xl mx-auto flex flex-col gap-8 py-4 md:py-32 items-center'>
                    ...
                    <div className='flex flex-col gap-1'>
                        <Link href='/podcast'>
                        <span className='text-[--uss-black] font-thin'>Regresar a PODCASTS</span>
                        </Link>
                        <h1 className=' text-4xl md:text-6xl font-normal text-[--uss-black]'>{post.title}</h1>
                    </div>
                    <div className='w-full'>
                        <iframe className='rounded-xl' src={post.podcast} width="100%" height="152" allowFullScreen allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                    </div>
                    ...
                    <div className='flex flex-col md:flex-row gap-4 justify-between w-full text-[--uss-black]'>
                        ...
                        <div className='flex flex-col gap-2 justify-end text-right'>
                            ...
                            <span className='text-[--uss-black] font-bold'>PODCASTS</span>
                        </div>
                    </div>
