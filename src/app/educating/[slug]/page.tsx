    ...
    return (
        <div className='container max-w-5xl mx-auto flex flex-col gap-8 py-4 md:py-32 items-center'>
            ...
            <div className='flex flex-col gap-1'>
                <Link href='/educating'>
                    <span className='text-uss-black font-thin'>Regresar a <b className='font-bold'>{categoryMapper[Category.BITS]}</b> </span>
                </Link>
            ...
            <SocialShareButtons url={`${Category.BITS}/${post.slug}`} title={post.title} />
